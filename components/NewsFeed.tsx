...
import { Zap, ZapOff, User, LogOut } from 'lucide-react';
...
export default function NewsFeed() {
    ...
    if (route === AppRoute.PROFILE) return <ProfilePage onBack={() => setRoute(AppRoute.FEED)} />;
            ...
            <div className="fixed top-0 left-0 right-0 z-[60] p-6 flex justify-between items-center bg-gradient-to-b from-slate-950/80 to-transparent pointer-events-none">
                ...
                <div className="flex items-center gap-4 pointer-events-auto">
                    ...
                    <button
                        ...
                        className="w-10 h-10 rounded-full glass flex items-center justify-center border-2 border-slate-700 hover:border-accent-500 transition-colors text-slate-400 hover:text-accent-400"
